...
export const SERVICE_NAME = 'dxen';
export const SERVICE_DESCRIPTION =
  'Dxen is an open-source AI agent that brings the power of Gemini directly into your terminal. It is designed to be a terminal-first, extensible, and powerful tool for developers, engineers, SREs, and beyond.';

// Dxen specific semantic conventions
