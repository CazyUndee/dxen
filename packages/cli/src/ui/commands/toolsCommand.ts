...
const listSubCommand: SlashCommand = {
  name: 'list',
  description: 'List available Dxen tools.',
...
const descSubCommand: SlashCommand = {
  ...
  description: 'List available Dxen tools with descriptions.',
  kind: CommandKind.BUILT_IN,
  autoExecute: true,
  action: async (context: CommandContext): Promise<void> =>
...
export const toolsCommand: SlashCommand = {
  name: 'tools',
  description:
    'List available Dxen tools. Use /tools desc to include descriptions.',
  kind: CommandKind.BUILT_IN,
  autoExecute: false,
